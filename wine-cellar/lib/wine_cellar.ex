defmodule WineCellar do
  ...
  # Instructions said these functions didn't
  # need to be modified, but it seems adding nil
  # matches is the most elegent solution. We'll see
  # if Exercism balks at it.
